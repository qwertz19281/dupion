...
impl GroupProfile {
    pub fn from_string(string_value: &str) -> Option<GroupProfile> {
        match string_value {
...
impl From<u64> for GroupProfile {
    fn from(flags: u64) -> GroupProfile {
        match flags & BLOCK_GROUP_PROFILE_MASK {
            0 => GroupProfile::Single,

            BLOCK_GROUP_RAID0 => GroupProfile::Raid0,

            BLOCK_GROUP_RAID1 => GroupProfile::Raid1,

            BLOCK_GROUP_RAID5 => GroupProfile::Raid5,

            BLOCK_GROUP_RAID6 => GroupProfile::Raid6,

            BLOCK_GROUP_DUP => GroupProfile::Dup,

            BLOCK_GROUP_RAID10 => GroupProfile::Raid10,

            _ => GroupProfile::Unknown,
        }
    }
}
