...
```
Deduplicate with optimization (--phys-only and --min-size to skip files that can't be deduped):
```
dupion --dedup btrfs --phys-only --min-size 2048 --max-size 10G -o - /home/user
```
